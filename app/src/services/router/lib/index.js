...
Location.prototype.path = function(v) {
  return this._path;
};
Location.prototype.setPath = function(v) {
  this._path = v;
  return this;
};
Location.prototype.state = function(v) {
  return this._state;
};
Location.prototype.setState = function(v) {
  this._state = v;
  return this;
};
...
Location.prototype.parse = function(url) {
  ...
  } else if (this._searchParams && this._path && this._path != path) {
...
Location.prototype.update = function(value) {
  if (value instanceof Object) {
    for (
      let v, i = 0, keys = Object.keys(value), l = keys.length, k;
      i < l;
      i++
    ) {
      k = keys[i];
...
Request.prototype.router = function(v) {
  return this._router;
};
Request.prototype.setRouter = function(v) {
  this._router = v;
  return this;
};
Request.prototype.referrer = function(v) {
  return this._referrer;
};
Request.prototype.setReferrer = function(v) {
  this._referrer = v;
  return this;
};
Request.prototype.aborted = function(v) {
  return this._aborted;
};
Request.prototype.setAborted = function(v) {
  this._aborted = v;
  return this;
};
Request.prototype.location = function(v) {
  return this._location;
};
Request.prototype.setLocation = function(v) {
  this._location = v;
  return this;
};
Request.prototype.state = function(v) {
  return this._state;
};
Request.prototype.setState = function(v) {
  this._state = v;
  return this;
};
Request.prototype.mode = function(v) {
  return this._mode;
};
Request.prototype.setMode = function(v) {
  this._mode = v;
  return this;
};
...
Request.prototype.abort = function(forced) {
  if (forced === undefined) forced = false;
  this._aborted = true;
  if (forced) {
    this._forceAbort = forced;
  }
  return this;
};
...
Router.prototype.__mode = {
  watch: 'modeDidSet',
  chainable: true,
  name: 'mode'
};
Router.prototype.mode = function(v) {
  return v !== undefined ? (this.setMode(v), this) : this._mode;
};
Router.prototype.setMode = function(v) {
  ...
  if (v != a) {
    this.modeDidSet && this.modeDidSet(v, a, this.__mode);
  }
  return this;
};
Router.prototype.busy = function(v) {
  return this._busy;
};
Router.prototype.setBusy = function(v) {
  this._busy = v;
  return this;
};
Router.prototype.root = function(v) {
  return this._root;
};
Router.prototype.setRoot = function(v) {
  this._root = v;
  return this;
};
...
Router.prototype.serializeParams = function(params) {
  if (params instanceof Object) {
    let res = [];
    for (
      let val, i = 0, keys = Object.keys(params), l = keys.length, key;
      i < l;
      i++
    ) {
      key = keys[i];
      val = params[key];
      res.push([key, encodeURI(val)].join('='));
    }
    var value = res;
    return value.join('&');
  }
...
Router.prototype.match = function(pattern) {
  var route =
    this._routes[pattern] || (this._routes[pattern] = new Route(this, pattern));
  return route.test();
};
...
Router.prototype.on = function(name) {
  ...
  var params = new Array(i > 1 ? i - 1 : 0);
  while (i > 1) params[--i - 1] = $0[i];
  return Imba.listen.apply(
    Imba,
    [].concat([this, name], [].slice.call(params))
  );
};
...
Router.prototype.onclick = function(e) {
  ...
  if (!el || !href || (href[0] != '#' && href[0] != '/' && href[0] != '?')) {
    return;
  }
...
Imba.extendTag('element', function(tag) {
  ...
  tag.prototype.params = function(v) {
    return this._params;
  };
  ...
  tag.prototype.router = function() {
    return (
      this._router ||
      (this._router = (this._owner_ && this._owner_.router()) || new Router())
    );
